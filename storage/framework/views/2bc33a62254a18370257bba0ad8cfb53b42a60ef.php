...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="<?php echo e(url('student/' .$students->id)); ?>" method="post">
        ...
        <input type="text" name="legacy" id="legacy" value="<?php echo e($students->legacy); ?>" class="form-control"></br>
...
<?php echo $__env->make('students.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mbd\mbdapp\resources\views/students/edit.blade.php ENDPATH**/ ?>